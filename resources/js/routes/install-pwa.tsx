        ...
        <div className="container mx-auto max-w-2xl px-4 py-6">
            ...
            <div className="space-y-6">
                ...
                <div className="rounded-lg bg-card p-6">
                    <h2 className="mb-4 text-lg font-semibold">Why install this app?</h2>
                ...
                <div className="rounded-lg bg-card p-6">
                    <h2 className="mb-4 text-lg font-semibold">How to install</h2>
                    <div className="space-y-4">
                        <div>
                            <h3 className="font-medium">On Chrome/Edge (Desktop)</h3>
                            <p className="text-sm text-muted-foreground">Click the install button in the address bar or use the button above</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">Tap the menu button and select "Add to Home screen"</p>
                        </div>
                    </div>
                </div>
            </div>
