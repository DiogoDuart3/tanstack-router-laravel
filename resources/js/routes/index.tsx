            ...
            <div className="container mx-auto max-w-6xl px-4 py-8">
                ...
                <div className="mb-16 space-y-6 text-center">
                    <div className="space-y-4">
                        <h1 className="bg-gradient-to-r from-primary via-primary/80 to-primary/60 bg-clip-text text-4xl font-bold text-transparent md:text-6xl">
                            Laravel TanStack
                        </h1>
                        <p className="mx-auto max-w-3xl text-xl text-muted-foreground md:text-2xl">
                            A modern, full-stack TypeScript starter kit combining Laravel API backend with TanStack Router frontend for building
                ...
                <Card className="mb-12 bg-card/50 backdrop-blur-sm">
                    <CardHeader>
                        ...
                        <p className="text-sm text-muted-foreground">Real-time connection status to the backend API</p>
                    </CardHeader>
                    <CardContent>
                        <div className="flex items-center gap-3">
                            <div className={`h-3 w-3 rounded-full ${healthCheck.data ? 'animate-pulse bg-green-500' : 'bg-red-500'}`} />
                ...
                <div className="mb-16">
                    <div className="mb-8 text-center">
                        ...
                        <p className="mx-auto max-w-2xl text-muted-foreground">
                            Built with modern tools and frameworks to ensure type safety, performance, and excellent developer experience using
                            Laravel API backend with TanStack Router frontend.
                        </p>
                    </div>
                            ...
                            <CardContent className="space-y-4">
                                {techStack.frontend.map((tech) => (
                                    <div key={tech.name} className="flex items-start gap-3">
                                        <tech.icon className="mt-0.5 h-5 w-5 flex-shrink-0 text-blue-500" />
                                        <div>
                        ...
                        <Card className="bg-card/50 backdrop-blur-sm">
                            ...
                            <CardContent className="space-y-4">
                                {techStack.backend.map((tech) => (
                                    <div key={tech.name} className="flex items-start gap-3">
                                        <tech.icon className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-500" />
                                        <div>
                                            <h4 className="font-medium">{tech.name}</h4>
                                            <p className="text-sm text-muted-foreground">{tech.description}</p>
                                        </div>
                        ...
                        <Card className="bg-card/50 backdrop-blur-sm">
                            ...
                            <CardContent className="space-y-4">
                                {techStack.styling.map((tech) => (
                                    <div key={tech.name} className="flex items-start gap-3">
                                        <tech.icon className="mt-0.5 h-5 w-5 flex-shrink-0 text-purple-500" />
                                        <div>
                                            <h4 className="font-medium">{tech.name}</h4>
                                            <p className="text-sm text-muted-foreground">{tech.description}</p>
                                        </div>
                        ...
                        <Card className="bg-card/50 backdrop-blur-sm">
                            ...
                            <CardContent className="space-y-4">
                                {techStack.features.map((tech) => (
                                    <div key={tech.name} className="flex items-start gap-3">
                                        <tech.icon className="mt-0.5 h-5 w-5 flex-shrink-0 text-orange-500" />
                                        <div>
                                            <h4 className="font-medium">{tech.name}</h4>
                                            <p className="text-sm text-muted-foreground">{tech.description}</p>
                                        </div>
                ...
                <Card className="mb-16 bg-card/50 backdrop-blur-sm">
                    <CardHeader>
                        ...
                        <p className="text-sm text-muted-foreground">Everything you need to build modern web applications</p>
                    </CardHeader>
                    <CardContent>
