...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="max-w-md w-full bg-white rounded-lg shadow-md p-6">
        <div class="mb-6 text-center">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Laravel Pulse</h1>
            <p class="text-gray-600 mt-2">Sign in to access the performance dashboard</p>
        </div>
        ...
        <form method="POST" action="/pulse/login">
            @csrf
            <div class="mb-4">
        ...
        <div class="mt-4 text-center">
            <a href="/" class="text-sm text-blue-600 hover:text-blue-500">← Back to application</a>
        </div>
    </div>
</body>
</html>